...
awk -F $'\t' 'BEGIN { FS="\t" }; {gsub(/ /,"_")};{print $1"."$2"."$3"\t"$4""$5";"}' taxmap_slv_ssu_ref_128.txt > taxmap_slv_ssu_ref_128_REady2.txt
sed 1d taxmap_slv_ssu_ref_128_REady2.txt > taxmap_slv_ssu_ref_128_REady.txt
